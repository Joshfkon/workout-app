...
const PUBLIC_ROUTES = ['/', '/login', '/register', '/learn', '/privacy', '/terms', '/support', '/pricing', '/auth/callback', '/forgot-password', '/reset-password', '/verify-code', '/opengraph-image', '/twitter-image', '/api/og'];
