...
const rightNavItems: NavItem[] = [
  ...
  },
  {
    ...
    matchPaths: ['/dashboard/feed', '/dashboard/discover', '/dashboard/profile'],
  },
  {
    name: 'More',
    ...
    // More links to settings but also highlights for AI Coach, etc.
    matchPaths: ['/dashboard/settings', '/dashboard/ai-coach', '/dashboard/science'],
  },
];
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-surface-900 border-t border-surface-800 lg:hidden">
      <div className="flex items-center justify-around h-16 px-2 safe-area-bottom">
        ...
        {/* Center Home button - large and raised */}
        <div className="flex flex-col items-center justify-center flex-1 -mt-6">
          <Link
            ...
            className={cn(
              ...
              isHomeActive && 'ring-2 ring-primary-400 ring-offset-2 ring-offset-surface-900'
            )}
          >
