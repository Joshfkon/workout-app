 ...
 * hand-held bicep-curl fixture CSV (same schema the app's raw export
 * writes). The checked-in fixture is a synthetic stand-in generated by
 * scripts/generate-motion-fixture.mjs to the documented ground truth —
 * replace fixtures/handheld-curl-sweep.csv with the real on-device capture
 * (Motion Capture → Download raw sweep) and update
 * fixtures/handheld-curl-sweep.expected.json to re-run against real data.
 */
