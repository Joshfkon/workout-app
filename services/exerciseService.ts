...
export interface Exercise {
  ...
  // Progression fields
  /** Rep range — a SECONDS range when exerciseType is 'duration_based' */
...
export async function createCustomExercise(
  ...
  try {
    // Creation-time attribution constraint: a group-level primary
    // ('shoulders', 'chest', 'back') splits credit uniformly across heads and
    // ranks the exercise's own target below its 0.5-credit secondaries — the
    // defect class the 2026-07 attribution audit retagged away. Reject at the
    // source so it cannot recur.
    const primaryError = validateExercisePrimary(exercise.primaryMuscle);
    if (primaryError) {
      const err = new Error(primaryError);
      (err as { code?: string }).code = 'GROUP_PRIMARY';
      throw err;
    }
    ...
    const payload = {
      ...
      exercise_type: exercise.exerciseType ?? 'rep_based',
    };
...
function mapDbExercise(row: Record<string, unknown>): Exercise {
  ...
  return {
    ...
    // Modality: duration exercises store seconds in rep-range/reps fields
    exerciseType: (row.exercise_type as ExerciseType) || 'rep_based',
    // Bodyweight exercise metadata
...
function getDefaultIncrement(equipment: Equipment): number {
  switch (equipment) {
    ...
    // 2.5 lb (1.13 kg): dumbbell racks/adjustables step in 2.5 lb below the
    // heavy end — the observed 77.5→80 lb jump. The old 2.0 kg (≈5 lb
    // pairs-jump assumption) rejected real load steps on rep-floor grounds
    // (see supabase/migrations/20260729000001_dumbbell_increment_granularity).
    case 'dumbbell': return 1.13;
...
const FALLBACK_EXERCISES_RAW: Exercise[] = [
  ...
  { id: 'arnold-press', name: 'Arnold Press', primaryMuscle: 'front_delts', secondaryMuscles: ['triceps', 'lateral_delts'], pattern: 'vertical_push', equipment: 'dumbbell', difficulty: 'intermediate', fatigueRating: 2, defaultRepRange: [8, 12], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'compound', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 4 }, stabilizers: ['abs'], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { shoulders: true }, contraindications: ['shoulder_impingement'], isBodyweight: false },
  ...
  { id: 'cable-lateral-raise', name: 'Cable Lateral Raise', primaryMuscle: 'lateral_delts', secondaryMuscles: [], pattern: 'isolation', equipment: 'cable', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 20], defaultRir: 2, minWeightIncrementKg: 2.5, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'A', stretchUnderLoad: 4, resistanceProfile: 5, progressionEase: 4 }, stabilizers: [], spinalLoading: 'none', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: {}, contraindications: [], isBodyweight: false },
  ...
  { id: 'close-grip-bench', name: 'Close-Grip Bench Press', primaryMuscle: 'triceps_lat_med', secondaryMuscles: ['chest', 'front_delts'], pattern: 'horizontal_push', equipment: 'barbell', difficulty: 'intermediate', fatigueRating: 2, defaultRepRange: [6, 10], defaultRir: 2, minWeightIncrementKg: 2.5, mechanic: 'compound', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 4 }, stabilizers: ['back', 'abs'], spinalLoading: 'moderate', requiresBackArch: true, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { lowerBack: true, elbows: true }, contraindications: ['lower_back_strain', 'elbow_tendinitis'], isBodyweight: false },
  ...
  { id: 'goblet-squat', name: 'Goblet Squat', primaryMuscle: 'quads', secondaryMuscles: ['glutes'], pattern: 'squat', equipment: 'dumbbell', difficulty: 'beginner', fatigueRating: 2, defaultRepRange: [10, 15], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'compound', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 3 }, stabilizers: ['abs'], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { knees: true }, contraindications: [], isBodyweight: false },
  ...
  { id: 'bulgarian-split-squat', name: 'Bulgarian Split Squat', primaryMuscle: 'quads', secondaryMuscles: ['glutes'], pattern: 'lunge', equipment: 'dumbbell', difficulty: 'intermediate', fatigueRating: 2, defaultRepRange: [8, 12], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'compound', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 4, resistanceProfile: 3, progressionEase: 3 }, stabilizers: ['abs'], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { knees: true, hips: true }, contraindications: ['knee_injury'], isBodyweight: false },
  ...
  { id: 'single-leg-rdl', name: 'Single Leg RDL', primaryMuscle: 'hamstrings', secondaryMuscles: ['glutes'], pattern: 'hip_hinge', equipment: 'dumbbell', difficulty: 'intermediate', fatigueRating: 2, defaultRepRange: [10, 15], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'compound', isCustom: false, hypertrophyScore: { tier: 'A', stretchUnderLoad: 4, resistanceProfile: 3, progressionEase: 3 }, stabilizers: ['abs'], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: true, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['lower_back_strain'], isBodyweight: false },
  ...
  { id: 'woodchop', name: 'Cable Woodchop', primaryMuscle: 'abs', secondaryMuscles: ['shoulders'], pattern: 'isolation', equipment: 'cable', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 15], defaultRir: 2, minWeightIncrementKg: 2.5, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'A', stretchUnderLoad: 4, resistanceProfile: 5, progressionEase: 4 }, stabilizers: ['back'], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: true, positionStress: { lowerBack: true }, contraindications: ['herniated_disc'], isBodyweight: false },

  // OBLIQUES
  { id: 'side-plank', name: 'Side Plank', primaryMuscle: 'obliques', secondaryMuscles: ['abs'], pattern: 'isolation', equipment: 'bodyweight', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [30, 60], defaultRir: 2, minWeightIncrementKg: 0, mechanic: 'isolation', isCustom: false, exerciseType: 'duration_based', notes: 'Rep range is seconds per side', hypertrophyScore: { tier: 'C', stretchUnderLoad: 2, resistanceProfile: 2, progressionEase: 2 }, stabilizers: ['shoulders'], spinalLoading: 'none', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { shoulders: true }, contraindications: [], isBodyweight: true, bodyweightType: 'pure' },
  { id: 'db-side-bend', name: 'Dumbbell Side Bend', primaryMuscle: 'obliques', secondaryMuscles: [], pattern: 'isolation', equipment: 'dumbbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 15], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 4, resistanceProfile: 3, progressionEase: 4 }, stabilizers: [], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['herniated_disc'], isBodyweight: false },

  // FOREARMS
  { id: 'barbell-wrist-curl', name: 'Barbell Wrist Curl', primaryMuscle: 'forearms', secondaryMuscles: [], pattern: 'isolation', equipment: 'barbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 20], defaultRir: 2, minWeightIncrementKg: 2.5, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 4, resistanceProfile: 3, progressionEase: 4 }, stabilizers: [], spinalLoading: 'none', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { wrists: true }, contraindications: ['wrist_strain'], isBodyweight: false },
  { id: 'db-wrist-curl', name: 'Dumbbell Wrist Curl', primaryMuscle: 'forearms', secondaryMuscles: [], pattern: 'isolation', equipment: 'dumbbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 20], defaultRir: 2, minWeightIncrementKg: 1.0, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 4, resistanceProfile: 3, progressionEase: 4 }, stabilizers: [], spinalLoading: 'none', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { wrists: true }, contraindications: ['wrist_strain'], isBodyweight: false },
  { id: 'reverse-wrist-curl', name: 'Reverse Wrist Curl', primaryMuscle: 'forearms', secondaryMuscles: [], pattern: 'isolation', equipment: 'dumbbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 20], defaultRir: 2, minWeightIncrementKg: 1.0, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 3 }, stabilizers: [], spinalLoading: 'none', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { wrists: true, elbows: true }, contraindications: ['wrist_strain', 'elbow_tendinitis'], isBodyweight: false },
  { id: 'ez-bar-reverse-curl', name: 'EZ Bar Reverse Curl', primaryMuscle: 'forearms', secondaryMuscles: ['biceps'], pattern: 'elbow_flexion', equipment: 'barbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [10, 15], defaultRir: 2, minWeightIncrementKg: 2.5, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 4 }, stabilizers: [], spinalLoading: 'none', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { wrists: true, elbows: true }, contraindications: ['elbow_tendinitis'], isBodyweight: false },

  // ERECTORS (LOWER BACK)
  { id: 'machine-back-extension', name: 'Machine Back Extension', primaryMuscle: 'erectors', secondaryMuscles: ['glutes'], pattern: 'hip_hinge', equipment: 'machine', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [12, 15], defaultRir: 2, minWeightIncrementKg: 5.0, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'A', stretchUnderLoad: 4, resistanceProfile: 4, progressionEase: 5 }, stabilizers: [], spinalLoading: 'moderate', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: true, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['herniated_disc', 'lower_back_strain'], isBodyweight: false },
  { id: 'superman-hold', name: 'Superman Hold', primaryMuscle: 'erectors', secondaryMuscles: ['glutes'], pattern: 'isolation', equipment: 'bodyweight', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [30, 60], defaultRir: 2, minWeightIncrementKg: 0, mechanic: 'isolation', isCustom: false, exerciseType: 'duration_based', notes: 'Rep range is seconds', hypertrophyScore: { tier: 'C', stretchUnderLoad: 2, resistanceProfile: 2, progressionEase: 2 }, stabilizers: [], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: true, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['lower_back_strain'], isBodyweight: true, bodyweightType: 'pure' },
  { id: 'jefferson-curl', name: 'Jefferson Curl', primaryMuscle: 'erectors', secondaryMuscles: ['hamstrings'], pattern: 'hip_hinge', equipment: 'dumbbell', difficulty: 'advanced', fatigueRating: 2, defaultRepRange: [8, 12], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'compound', isCustom: false, notes: 'Use light weight - loaded spinal flexion', hypertrophyScore: { tier: 'B', stretchUnderLoad: 5, resistanceProfile: 2, progressionEase: 3 }, stabilizers: ['hamstrings'], spinalLoading: 'high', requiresBackArch: false, requiresSpinalFlexion: true, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['herniated_disc', 'lower_back_strain', 'sciatica'], isBodyweight: false },

  // FUNCTIONAL / CARRIES
  { id: 'farmers-carry', name: "Farmer's Carry", primaryMuscle: 'abs', secondaryMuscles: ['shoulders', 'back'], pattern: 'carry', equipment: 'dumbbell', difficulty: 'beginner', fatigueRating: 2, defaultRepRange: [30, 60], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'compound', isCustom: false, exerciseType: 'duration_based', notes: 'Rep range is seconds, not reps', hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 4 }, stabilizers: ['back'], spinalLoading: 'moderate', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['lower_back_strain'], isBodyweight: false },
  ...
  // TRAPS (residuals pass): the fallback pool carried NO traps-primary
  // movement, so the generator could allocate traps sets but never select an
  // exercise for them. Names match the seed rows, so the seed-derived tags
  // (upper_traps primary post-20260713000001) apply via SEED_EXERCISE_TAGS.
  { id: 'db-shrug', name: 'Dumbbell Shrug', primaryMuscle: 'traps', secondaryMuscles: [], pattern: 'isolation', equipment: 'dumbbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [10, 15], defaultRir: 2, minWeightIncrementKg: 1.13, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 5 }, stabilizers: ['forearms'], spinalLoading: 'low', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: {}, contraindications: [], isBodyweight: false },
  { id: 'bb-shrug', name: 'Barbell Shrug', primaryMuscle: 'traps', secondaryMuscles: [], pattern: 'isolation', equipment: 'barbell', difficulty: 'beginner', fatigueRating: 1, defaultRepRange: [10, 15], defaultRir: 2, minWeightIncrementKg: 2.5, mechanic: 'isolation', isCustom: false, hypertrophyScore: { tier: 'B', stretchUnderLoad: 3, resistanceProfile: 3, progressionEase: 5 }, stabilizers: ['forearms'], spinalLoading: 'moderate', requiresBackArch: false, requiresSpinalFlexion: false, requiresSpinalExtension: false, requiresSpinalRotation: false, positionStress: { lowerBack: true }, contraindications: ['lower_back_strain'], isBodyweight: false },
